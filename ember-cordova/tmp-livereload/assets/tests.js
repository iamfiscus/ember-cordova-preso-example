...
define('ember-cordova-preso/tests/controllers/application.jshint', ['exports'], function (exports) {
  'use strict';
...
define('ember-cordova-preso/tests/routes/application.jshint', ['exports'], function (exports) {
  'use strict';
